...
\dspdeclareoperator{dspdiffbottompart}{
	% Coordinate offset for the plus
	\pgfutil@tempdima=\radius
	\pgfutil@tempdima=0.7\pgfutil@tempdima
	
	% Draw plus
         \pgftext[center,center,at={\pgfpoint{-\pgfutil@tempdima}{0pt}}]{$+$}
         \pgftext[center,center,at={\pgfpoint{0pt}{-\pgfutil@tempdima}}]{$-$}
        \pgftext[center,center,at={\pgfpoint{0pt}{0pt}}]{enc}
		
	\pgfusepathqstroke
}

\dspdeclareoperator{dspdecoder}{
	% Coordinate offset for the plus
	\pgfutil@tempdima=\radius
	\pgfutil@tempdima=0.7\pgfutil@tempdima
...
%         \pgftext[center,center,at={\pgfpoint{-\pgfutil@tempdima}{0pt}}]{$+$}
%         \pgftext[center,center,at={\pgfpoint{0pt}{-\pgfutil@tempdima}}]{$-$}
        \pgftext[center,center,at={\pgfpoint{0pt}{0pt}}]{dec}
		
	\pgfusepathqstroke
}


\dspdeclareoperator{dspdifftoppart}{
	% Coordinate offset for the plus
	\pgfutil@tempdima=\radius
	\pgfutil@tempdima=0.7\pgfutil@tempdima
...
\tikzset{dspmedsquare/.style={shape=rectangle,draw,align=center,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=1.5*\dspsquareblocksize}}
\tikzset{dspbigsquare/.style={shape=rectangle,draw,align=center,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=2*\dspsquareblocksize}}
\tikzset{dspcloud/.style={shape=cloud,draw,align=center,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=2*\dspsquareblocksize}}
\tikzset{dspsetbotenc/.style={shape=dspdiffbottompart,draw,align=center,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=2*\dspsquareblocksize}}

\tikzset{dspsetdec/.style={shape=dspdecoder,draw,align=center,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=2*\dspsquareblocksize}}


\tikzset{dspsettopenc/.style={shape=dspdifftoppart,draw,align=center,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=2*\dspsquareblocksize}}

\tikzset{dspelongated/.style={shape=rectangle,draw,align=center,
	line cap=round,line join=round,line width=\dsplinewidth,minimum width=3.0*\dspsquareblocksize,minimum height=1.25*\dspsquareblocksize}}
 
\tikzset{dspdiamond/.style={shape=diamond,draw,align=center,text depth=0.3em,text height=1em,inner sep=0pt,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=1.75*\dspsquareblocksize}}
 
\tikzset{dsphash/.style={shape=trapezium,shape border rotate=180,rotate=90,text centered,minimum width=20mm,draw,minimum height=25mm,align=center,inner sep=0pt,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=\dspsquareblocksize}}
 
\tikzset{dspcircle/.style={shape=circle,draw,align=center,text depth=0.3em,text height=1em,inner sep=0pt,
	line cap=round,line join=round,line width=\dsplinewidth,minimum size=\dspsquareblocksize*1.4}}
